...
@include('components.admin_sidebar')
            <div class="col-md-10 offset-md-1 col-lg-8 offset-lg-0">
                ...
                <div class="widget dashboard-container my-adslist">
                    <h3 class="widget-header">Tambah Blog Post</h3>
                    <form action="{{ url('admin/dashboard/blog/post/create') }}" method="POST" enctype="multipart/form-data">
                        @csrf
                        <fieldset class="p-4">
                            <label for="title">Judul</label>
                            <input type="text" name="title" class="border p-3 w-100 my-2">
